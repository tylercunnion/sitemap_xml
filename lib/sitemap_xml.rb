...
module SitemapXml
  ...
  module SitemapClassMethods
    ...
    def set_sitemap(args)
      sitemapped_actions = []
      options = args.extract_options!
      
      possible_actions = [*(self.action_methods - ApplicationController.action_methods)].collect{|a| a.to_sym}
    ...
    def enable_sitemap(*args)
      puts "Self: " + self.to_s
      define_method :get_sitemap do
        self.class.set_sitemap(args)
      end
      hide_action("get_sitemap")
    end
